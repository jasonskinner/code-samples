...
function site_scripts() {
	...
	wp_enqueue_script( 'equalizer-js', get_template_directory_uri() . '/assets/scripts/vue/equalizer.js', array( 'vue' ), get_template_directory() . '/assets/scripts/vue.equalizer.js', true );

	// Vue JS
	if ( defined( 'WP_LOCAL_DEV') === true ) {
		wp_enqueue_script('vue', 'https://cdn.jsdelivr.net/npm/vue@2.6.7/dist/vue.js', [], '2.6.7', true );
	}else{
		wp_enqueue_script('vue', 'https://cdn.jsdelivr.net/npm/vue@2.5.17/dist/vue.min.js', [], '2.5.17', true );
	}
}
